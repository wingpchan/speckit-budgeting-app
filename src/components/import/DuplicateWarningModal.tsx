...
function ExactDuplicateContent({ priorImportDate, onOverride, onCancel }: ExactDuplicateProps) {
  return (
    <>
      <h2 className="text-lg font-semibold text-red-700 mb-2">Duplicate File Detected</h2>
...
function DateRangeOverlapContent({ overlapRange, onProceed, onCancel }: DateRangeOverlapProps) {
  return (
    <>
      <h2 className="text-lg font-semibold text-yellow-700 mb-2">Date Range Overlap Detected</h2>
      <p className="text-sm text-gray-700 mb-4">
