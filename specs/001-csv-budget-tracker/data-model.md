...
**Branch**: `001-csv-budget-tracker` | **Date**: 2026-03-20
**Source**: spec.md v1.9.0 + research.md
...
Note: specific multi-word keywords are listed before their general substrings to ensure correct first-match-wins priority (e.g. TESCO MOBILE before TESCO, SKY MOBILE before SKY, EDF ENERGY before EDF, MORTGAGE PAYMENT before MORTGAGE, TV LICENCE before BP/Fuel section, UBER EATS before UBER, AMAZON GAMES before AMAZON, GEORGE AT ASDA before ASDA, TAX CREDIT/WORKING TAX before TAX, FASTER PAYMENT RECEIVED before PAYMENT RECEIVED).

| Keyword(s) | Category | Ordering note |
|---|---|---|
| TV LICENCE | Utilities | Must precede Fuel section; 'BP' would match 'MBP' in 'TV LICENCE MBP' |
| TESCO FUEL, SAINSBURYS FUEL, ASDA FUEL, MORRISONS FUEL | Fuel | Must precede grocery keywords |
| GEORGE AT ASDA | Shopping | Must precede ASDA → Groceries |
| TESCO MOBILE | Telecoms | Must precede TESCO → Groceries |
...
| SKY MOBILE | Telecoms | Must precede SKY → Subscriptions |
...
| UBER EATS | Eating Out | Must precede UBER → Transport |
| COSTA, STARBUCKS, CAFE, GREGGS, MCDONALDS, BURGER KING, KFC, PIZZA, NANDOS, SUBWAY, DELIVEROO, JUST EAT, FIVE GUYS, WAGAMAMA, PRET A MANGER, LEON, ITSU, WASABI, YO SUSHI, HARVESTER, TOBY CARVERY, WEATHER SPOONS, WETHERSPOONS, PUB, BAR , RESTAURANT | Eating Out | BAR includes trailing space to avoid false matches |
| AMAZON GAMES | Entertainment | Must precede AMAZON → Shopping |
| NATIONAL LOTTERY, LOTTERY, LOTTO, CINEMA, ODEON, VUE, CINEWORLD, THEATRE, TICKETMASTER, EVENTBRITE, STEAM, PLAYSTATION, XBOX, NINTENDO, APPLE ARCADE | Entertainment | NATIONAL LOTTERY before LOTTERY |
| AMAZON, EBAY, ASOS, H&M, ZARA, NEXT, JOHN LEWIS, PRIMARK, IKEA, MARKS & SPENCER, M&S , DEBENHAMS, RIVER ISLAND, TOPSHOP, NEW LOOK, SPORTS DIRECT, JD SPORTS, FOOTLOCKER, CURRYS, ARGOS, HALFORDS, DUNELM, MATALAN | Shopping | M&S includes trailing space; MARKS & SPENCER FOOD / M&S FOOD (Groceries) take priority |
| UBER, BOLT, TAXI, TRAINLINE, NATIONAL RAIL, TFL, BUS, AVANTI, GREAT WESTERN, SOUTHERN RAIL, SOUTHEASTERN, THAMESLINK, CHILTERN, CROSSCOUNTRY, NORTHERN RAIL, STAGECOACH, ARRIVA, FIRST BUS, CYCLE, LIME , BIRD , TIER  | Transport | LIME /BIRD /TIER  include trailing space |
| SHELL, BP, ESSO, TEXACO, MOTO, FUEL, MOTORWAY SERVICES, WELCOME BREAK, ROADCHEF, EXTRA MSA | Fuel | |
...
| MORTGAGE PAYMENT, NATIONWIDE C/CARD, NATIONWIDE CREDIT, B/CARD, BARCLAYCARD, AMEX, AMERICAN EXPRESS, CAPITAL ONE, VANQUIS, AQUA CARD, VIRGIN MONEY CREDIT, MBNA, LOAN PAYMENT, CARD PAYMENT TO, ONLINE PAYMENT TO, STANDING ORDER TO, FASTER PAYMENT TO | Internal Transfer | MORTGAGE PAYMENT before MORTGAGE → Housing |
...
| NOW BROADBAND | Telecoms | Must precede BROADBAND → Utilities |
| GAS, ELECTRIC, WATER, BROADBAND, EDF, BRITISH GAS, EON, E.ON, NPOWER, BULB, BBC, THAMES WATER, ANGLIAN WATER, SEVERN TRENT, UNITED UTILITIES, YORKSHIRE WATER, WESSEX WATER, SOUTHERN WATER, AFFINITY WATER | Utilities | TV LICENCE moved to map top |
| VODAFONE, EE , O2 , THREE, GIFFGAFF, BT , VIRGIN MEDIA, TALKTALK, PLUSNET, ID MOBILE, SMARTY, LEBARA | Telecoms | EE /O2 /BT  include trailing space |
| DIRECT LINE, AVIVA, LV=, ADMIRAL, AXA | Insurance | |
| TAX CREDIT, WORKING TAX | Income | Must precede TAX → Taxes |
| HMRC, COUNCIL TAX REFUND, TAX | Taxes | COUNCIL TAX REFUND before TAX |
| SALARY, PAYROLL, BACS CREDIT, WAGES, BANK CREDIT, FASTER PAYMENT IN, FASTER PAYMENT RECEIVED, STANDING ORDER IN, INTEREST PAID, CASHBACK, REFUND, CHILD BENEFIT, UNIVERSAL CREDIT | Income | FASTER PAYMENT RECEIVED before PAYMENT RECEIVED (Internal Transfer) |
